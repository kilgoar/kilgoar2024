Shader "Custom/Rust/Water"
{
    Properties
    {
        ...
        [Enum(Opaque,0,Transparent,1)] _Mode("Rendering Mode", Float) = 1
        [HideInInspector] _SrcBlend("Source Blend", Float) = 5.0 // SrcAlpha
    ...
    CustomEditor "RustWaterShaderGUI"
}